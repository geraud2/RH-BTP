    ...
    <div className={`fixed inset-0 z-[100] bg-[#0f0f1a] flex flex-col items-center justify-center transition-opacity duration-500 ${fadeOut ? 'opacity-0' : 'opacity-100'}`}>
      ...
      <div className="relative z-10 flex flex-col items-center gap-8">
        ...
        <div className="flex items-center gap-6">
          <div className="flex flex-col items-center gap-1.5 opacity-60"><div className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center"><Users size={20} className="text-amber-400" /></div></div>
          <div className="flex flex-col items-center gap-1.5"><div className="w-12 h-12 rounded-xl bg-amber-500/10 flex items-center justify-center"><Building2 size={24} className="text-amber-400" /></div></div>
          <div className="flex flex-col items-center gap-1.5 opacity-60"><div className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center"><FileText size={20} className="text-amber-400" /></div></div>
        </div>

        <div className="text-center">
          <h1 className="text-3xl font-extrabold text-white tracking-tight">Enterprise<span className="text-amber-500"> RH</span> Manager</h1>
          <p className="text-sm text-gray-500 mt-2 font-medium tracking-wide">Gestion des ressources humaines</p>
        </div>

        <div className="w-56 space-y-2">
          <div className="h-1.5 bg-gray-800 rounded-full overflow-hidden"><div className="h-full bg-gradient-to-r from-amber-600 to-amber-400 rounded-full transition-all duration-75 ease-linear" style={{ width: `${progress}%` }} /></div>
          <p className="text-center text-xs text-gray-600 font-medium">{progress}%</p>
        </div>

        <p className="text-xs text-gray-700 tracking-widest uppercase">Ressources Humaines</p>
      </div>
